...
__device__ MatT eigenprim_make_outer(VecT a, VecT b) {
  MatT result;
#pragma unroll
  for (int col = 0; col < MatT::ColsAtCompileTime; ++col) {
#pragma unroll
    for (int row = 0; row < MatT::RowsAtCompileTime; ++row) {
...
__device__ EigenMat2f eigen_vec2f_outer(EigenVec2f a, EigenVec2f b) { return eigenprim_make_outer<EigenMat2f>(a, b); }
...
__device__ EigenMat3f eigen_vec3f_outer(EigenVec3f a, EigenVec3f b) { return eigenprim_make_outer<EigenMat3f>(a, b); }
...
__device__ EigenMat4f eigen_vec4f_outer(EigenVec4f a, EigenVec4f b) { return eigenprim_make_outer<EigenMat4f>(a, b); }
...
__device__ EigenMat2d eigen_vec2d_outer(EigenVec2d a, EigenVec2d b) { return eigenprim_make_outer<EigenMat2d>(a, b); }
...
__device__ EigenMat3d eigen_vec3d_outer(EigenVec3d a, EigenVec3d b) { return eigenprim_make_outer<EigenMat3d>(a, b); }
...
__device__ EigenMat4d eigen_vec4d_outer(EigenVec4d a, EigenVec4d b) { return eigenprim_make_outer<EigenMat4d>(a, b); }
...
__device__ EigenMat2h eigen_vec2h_outer(EigenVec2h a, EigenVec2h b) { return eigenprim_make_outer<EigenMat2h>(a, b); }
...
__device__ EigenMat3h eigen_vec3h_outer(EigenVec3h a, EigenVec3h b) { return eigenprim_make_outer<EigenMat3h>(a, b); }
...
__device__ EigenMat4h eigen_vec4h_outer(EigenVec4h a, EigenVec4h b) { return eigenprim_make_outer<EigenMat4h>(a, b); }
...
__device__ EigenMat2bf eigen_vec2bf_outer(EigenVec2bf a, EigenVec2bf b) { return eigenprim_make_outer<EigenMat2bf>(a, b); }
...
__device__ EigenMat3bf eigen_vec3bf_outer(EigenVec3bf a, EigenVec3bf b) { return eigenprim_make_outer<EigenMat3bf>(a, b); }
...
__device__ EigenMat4bf eigen_vec4bf_outer(EigenVec4bf a, EigenVec4bf b) { return eigenprim_make_outer<EigenMat4bf>(a, b); }
