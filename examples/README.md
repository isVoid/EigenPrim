...
| [11_numpy_aos.py](11_numpy_aos.py) | AoS patterns: batch dot products, normalize, and mat-vec multiply using 2D/3D numpy arrays directly; `numpy_utils` for AoS↔SoA host-side conversion. |
